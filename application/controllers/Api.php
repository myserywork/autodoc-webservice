    ...
    public function atualiza_autodoc() {       
        ...
        foreach($pendencias as $pendencia) {
            ...
            $dados = array(
                ...
                'BAIRRO_PROPONENTE' => (array_key_exists('bairroDistrito', $convenio_webservice['dadosProponente']) && $convenio_webservice['dadosProponente']['bairroDistrito'] != "") ? $convenio_webservice['dadosProponente']['bairroDistrito'] : '',
