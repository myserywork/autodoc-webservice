...
class Api extends CI_Controller {
    ...
    public function atualiza_autodoc() {       
        ...
        foreach($pendencias as $pendencia) {
            ...
            $dados = array(
                'NR_CONVENIO' => isset($convenio_webservice['sequencial']) ? $convenio_webservice['sequencial'] : '',
                'NR_PROPOSTA' => isset($convenio_webservice['numeroInterno']) ? $convenio_webservice['numeroInterno'] : '',
                'MUNIC_PROPONENTE' => isset($convenio_webservice['dadosProponente']['municWS']['nome']) ? $convenio_webservice['dadosProponente']['municWS']['nome'] : '',
                'COD_MUNIC_IBGE' => isset($proposta_dados_publicos['COD_MUNIC_IBGE']) ? $proposta_dados_publicos['COD_MUNIC_IBGE'] : '',
                'COD_ORGAO_SUP' => isset($convenio_webservice['propostaWS']['orgaoConcedenteWS']['codigo']) ? $convenio_webservice['propostaWS']['orgaoConcedenteWS']['codigo'] : '',
                'DESC_ORGAO_SUP' => isset($proposta_dados_publicos['DESC_ORGAO_SUP']) ? $proposta_dados_publicos['DESC_ORGAO_SUP'] : '',
                'NATUREZA_JURIDICA' => isset($proposta_dados_publicos['NATUREZA_JURIDICA']) ? $proposta_dados_publicos['NATUREZA_JURIDICA'] : '',
                'DIA_PROP' => isset($convenio_webservice['propostaWS']['dataPropostaWS']) ? date("d", strtotime($convenio_webservice['propostaWS']['dataPropostaWS'])) : '',
                'MES_PROP' => isset($convenio_webservice['propostaWS']['dataPropostaWS']) ? date("m", strtotime($convenio_webservice['propostaWS']['dataPropostaWS'])) : '',
                'ANO_PROP' => isset($convenio_webservice['propostaWS']['dataPropostaWS']) ? date("Y", strtotime($convenio_webservice['propostaWS']['dataPropostaWS'])) : '',
                'DIA_PROPOSTA' => isset($convenio_webservice['propostaWS']['dataPropostaWS']) ? date("d/m/Y", strtotime($convenio_webservice['propostaWS']['dataPropostaWS'])) : '',
                'COD_ORGAO' => isset($proposta_dados_publicos['COD_ORGAO']) ? $proposta_dados_publicos['COD_ORGAO'] : '',
                'DESC_ORGAO' => isset($proposta_dados_publicos['DESC_ORGAO']) ? $proposta_dados_publicos['DESC_ORGAO'] : '',
                'MODALIDADE' => isset($convenio_webservice['propostaWS']['modalidadePropostaWS']['value']) ? $convenio_webservice['propostaWS']['modalidadePropostaWS']['value'] : '',
                'NM_BANCO' => isset($convenio_webservice['propostaWS']['contaBancariaWS']['bancoWS']['nome']) ? $convenio_webservice['propostaWS']['contaBancariaWS']['bancoWS']['nome'] : '',
                'SITUACAO_CONTA' => isset($convenio_webservice['propostaWS']['contaBancariaWS']['situacao']) ? $convenio_webservice['propostaWS']['contaBancariaWS']['situacao'] : '',
                'SITUACAO_PROJETO_BASICO' => isset($convenio_webservice['propostaWS']['situacaoProjetoBasicoWS']['value']) ? $convenio_webservice['propostaWS']['situacaoProjetoBasicoWS']['value'] : '',
                'SIT_PROPOSTA' => isset($proposta_dados_publicos['SIT_PROPOSTA']) ? $proposta_dados_publicos['SIT_PROPOSTA'] : '',
                'DIA_INIC_VIGENCIA_PROPOSTA' => isset($convenio_webservice['propostaWS']['cronogramaFisicoWS']['metaCronogramaFisicoWS']['dataInicio']) ? $convenio_webservice['propostaWS']['cronogramaFisicoWS']['metaCronogramaFisicoWS']['dataInicio'] : '',
                'DIA_FIM_VIGENCIA_PROPOSTA' => isset($convenio_webservice['propostaWS']['cronogramaFisicoWS']['metaCronogramaFisicoWS']['dataFim']) ? $convenio_webservice['propostaWS']['cronogramaFisicoWS']['metaCronogramaFisicoWS']['dataFim'] : '',
                'OBJETO_PROPOSTA' => isset($convenio_webservice['propostaWS']['objetoConvenio']) ? $convenio_webservice['propostaWS']['objetoConvenio'] : '',
                'ITEM_INVESTIMENTO' => isset($proposta_dados_publicos['ITEM_INVESTIMENTO']) ? $proposta_dados_publicos['ITEM_INVESTIMENTO'] : '',
                'ENVIADA_MANDATARIA' => isset($proposta_dados_publicos['ENVIADA_MANDATARIA']) ? $proposta_dados_publicos['ENVIADA_MANDATARIA'] : '',
                'NOME_SUBTIPO_PROPOSTA' => isset($proposta_dados_publicos['NOME_SUBTIPO_PROPOSTA']) ? $proposta_dados_publicos['NOME_SUBTIPO_PROPOSTA'] : '',
                'DESCRICAO_SUBTIPO_PROPOSTA' => isset($proposta_dados_publicos['DESCRICAO_SUBTIPO_PROPOSTA']) ? $proposta_dados_publicos['DESCRICAO_SUBTIPO_PROPOSTA'] : '',
                'VL_GLOBAL_PROP' => isset($convenio_webservice['propostaWS']['valorGlobal']) ? $convenio_webservice['propostaWS']['valorGlobal'] : '',
                'VL_REPASSE_PROP' => isset($convenio_webservice['propostaWS']['valorRepasse']) ? $convenio_webservice['propostaWS']['valorRepasse'] : '',
                'VL_CONTRAPARTIDA_PROP' => isset($convenio_webservice['propostaWS']['valorContraPartida']) ? $convenio_webservice['propostaWS']['valorContraPartida'] : '',
                'DIA' => isset($convenio_webservice['assinaturaConvenioWS']['dataAssinatura']) ? date("d", strtotime($convenio_webservice['assinaturaConvenioWS']['dataAssinatura'])) : '',
                'MES' => isset($convenio_webservice['assinaturaConvenioWS']['dataAssinatura']) ? date("m", strtotime($convenio_webservice['assinaturaConvenioWS']['dataAssinatura'])) : '',
                'ANO' => isset($convenio_webservice['assinaturaConvenioWS']['dataAssinatura']) ? date("Y", strtotime($convenio_webservice['assinaturaConvenioWS']['dataAssinatura'])) : '',
                'DIA_ASSIN_CONV' => isset($convenio_webservice['assinaturaConvenioWS']['dataAssinatura']) ? date("d/m/Y", strtotime($convenio_webservice['assinaturaConvenioWS']['dataAssinatura'])) : '',
                'SIT_CONVENIO' => isset($convenio_dados_publicos['SIT_CONVENIO']) ? $convenio_dados_publicos['SIT_CONVENIO'] : '',
                'SUBSITUACAO_CONV' => isset($convenio_dados_publicos['SUBSITUACAO_CONV']) ? $convenio_dados_publicos['SUBSITUACAO_CONV'] : '',
                'SITUACAO_PUBLICACAO' => isset($convenio_dados_publicos['SITUACAO_PUBLICACAO']) ? $convenio_dados_publicos['SITUACAO_PUBLICACAO'] : '',
                'INSTRUMENTO_ATIVO' => isset($convenio_dados_publicos['INSTRUMENTO_ATIVO']) ? $convenio_dados_publicos['INSTRUMENTO_ATIVO'] : '',
                'IND_OPERA_OBTV' => isset($convenio_dados_publicos['IND_OPERA_OBTV']) ? $convenio_dados_publicos['IND_OPERA_OBTV'] : '',
                'NR_PROCESSO' => isset($convenio_webservice['numeroProcesso']) ? $convenio_webservice['numeroProcesso'] : '',
                'UG_EMITENTE' => isset($convenio_webservice['propostaWS']['empenhoWS']['ugEmitente']) ? $convenio_webservice['propostaWS']['empenhoWS']['ugEmitente'] : '',
                'DIA_PUBL_CONV' => isset($convenio_webservice['publicacaoConvenioWS']['dataPublicacao']) ? $convenio_webservice['publicacaoConvenioWS']['dataPublicacao'] : '',
                'DIA_INIC_VIGENC_CONV' => isset($convenio_webservice['inicioExecucao']) ? date("d/m/Y", strtotime($convenio_webservice['inicioExecucao'])) : '',
                'DIA_FIM_VIGENC_CONV' => isset($convenio_webservice['fimExecucao']) ? date("d/m/Y", strtotime($convenio_webservice['fimExecucao'])) : '',
                'DIA_FIM_VIGENC_ORIGINAL_CONV' => isset($convenio_dados_publicos['DIA_FIM_VIGENC_ORIGINAL_CONV']) ? $convenio_dados_publicos['DIA_FIM_VIGENC_ORIGINAL_CONV'] : '',
                'DIAS_PREST_CONTAS' => isset($convenio_webservice['assinaturaConvenioWS']['prazoPrestacaoContasDias']) ? $convenio_webservice['assinaturaConvenioWS']['prazoPrestacaoContasDias'] : '',
                'DIA_LIMITE_PREST_CONTAS' => isset($convenio_webservice['assinaturaConvenioWS']['dataPrestacaoContas']) ? $convenio_webservice['assinaturaConvenioWS']['dataPrestacaoContas'] : '',
                ...
                'DATA_RETIRADA_SUSPENSIVA' => isset($convenio_dados_publicos['DATA_RETIRADA_SUSPENSIVA']) ? $convenio_dados_publicos['DATA_RETIRADA_SUSPENSIVA'] : '',
                'DIAS_CLAUSULA_SUSPENSIVA' => isset($convenio_dados_publicos['DIAS_CLAUSULA_SUSPENSIVA']) ? $convenio_dados_publicos['DIAS_CLAUSULA_SUSPENSIVA'] : '',
                'SITUACAO_CONTRATACAO' => isset($convenio_dados_publicos['SITUACAO_CONTRATACAO']) ? $convenio_dados_publicos['SITUACAO_CONTRATACAO'] : '',
                'IND_ASSINADO' => isset($convenio_dados_publicos['IND_ASSINADO']) ? $convenio_dados_publicos['IND_ASSINADO'] : '',
                'MOTIVO_SUSPENSAO' => isset($convenio_dados_publicos['MOTIVO_SUSPENSAO']) ? $convenio_dados_publicos['MOTIVO_SUSPENSAO'] : '',
                'IND_FOTO' => isset($convenio_dados_publicos['IND_FOTO']) ? $convenio_dados_publicos['IND_FOTO'] : '',
                'QTDE_CONVENIOS' => isset($convenio_dados_publicos['QTDE_CONVENIOS']) ? $convenio_dados_publicos['QTDE_CONVENIOS'] : '',
                'QTD_TA' => isset($convenio_dados_publicos['QTD_TA']) ? $convenio_dados_publicos['QTD_TA'] : '',
                'QTD_PRORROGA' => isset($convenio_dados_publicos['QTD_PRORROGA']) ? $convenio_dados_publicos['QTD_PRORROGA'] : '',
                'VL_GLOBAL_CONV' => isset($convenio_webservice['propostaWS']['valorGlobal']) ? $convenio_webservice['propostaWS']['valorGlobal'] : '',
                'VL_REPASSE_CONV' => isset($convenio_webservice['propostaWS']['valorRepasse']) ? $convenio_webservice['propostaWS']['valorRepasse'] : '',
                'VL_CONTRAPARTIDA_CONV' => isset($convenio_webservice['propostaWS']['valorContraPartida']) ? $convenio_webservice['propostaWS']['valorContraPartida'] : '',
                'VL_EMPENHADO_CONV' => isset($convenio_webservice['propostaWS']['empenhoWS']['valorOriginal']) ? $convenio_webservice['propostaWS']['empenhoWS']['valorOriginal'] : '',
                'VL_DESEMBOLSADO_CONV' => isset($convenio_dados_publicos['VL_DESEMBOLSADO_CONV']) ? $convenio_dados_publicos['VL_DESEMBOLSADO_CONV'] : '',
                'VL_SALDO_REMAN_TESOURO' => isset($convenio_dados_publicos['VL_SALDO_REMAN_TESOURO']) ? $convenio_dados_publicos['VL_SALDO_REMAN_TESOURO'] : '',
                'VL_SALDO_REMAN_CONVENENTE' => isset($convenio_dados_publicos['VL_SALDO_REMAN_CONVENENTE']) ? $convenio_dados_publicos['VL_SALDO_REMAN_CONVENENTE'] : '',
                'VL_RENDIMENTO_APLICACAO' => isset($convenio_dados_publicos['VL_RENDIMENTO_APLICACAO']) ? $convenio_dados_publicos['VL_RENDIMENTO_APLICACAO'] : '',
                'VL_INGRESSO_CONTRAPARTIDA' => isset($convenio_dados_publicos['VL_INGRESSO_CONTRAPARTIDA']) ? $convenio_dados_publicos['VL_INGRESSO_CONTRAPARTIDA'] : '',
                'VL_SALDO_CONTA' => isset($convenio_dados_publicos['VL_SALDO_CONTA']) ? $convenio_dados_publicos['VL_SALDO_CONTA'] : '',
                'VALOR_GLOBAL_ORIGINAL_CONV' => isset($convenio_dados_publicos['VALOR_GLOBAL_ORIGINAL_CONV']) ? $convenio_dados_publicos['VALOR_GLOBAL_ORIGINAL_CONV'] : '',
                'ID_PROPONENTE' => isset($convenio_webservice['dadosProponente']['identificacao']) ? $convenio_webservice['dadosProponente']['identificacao'] : '',
                'IDENTIF_PROPONENTE' => isset($convenio_webservice['propostaWS']['proponenteWS']['identificacao']) ? $convenio_webservice['propostaWS']['proponenteWS']['identificacao'] : '',
                'NM_PROPONENTE' => isset($convenio_webservice['dadosProponente']['nome']) ? $convenio_webservice['dadosProponente']['nome'] : '',
                'MUNICIPIO_PROPONENTE' => isset($convenio_webservice['dadosProponente']['municWS']['nome']) ? $convenio_webservice['dadosProponente']['municWS']['nome'] : '',
                'UF_PROPONENTE' => isset($convenio_webservice['dadosProponente']['municWS']['unidadeFederativaWS']['sigla']) ? $convenio_webservice['dadosProponente']['municWS']['unidadeFederativaWS']['sigla'] : '',
                'ENDERECO_PROPONENTE' => isset($convenio_webservice['dadosProponente']['endereco']) && isset($convenio_webservice['dadosProponente']['bairroDistrito']) && isset($convenio_webservice['dadosProponente']['municWS']['nome']) && isset($convenio_webservice['dadosProponente']['municWS']['unidadeFederativaWS']['sigla']) && isset($convenio_webservice['dadosProponente']['cep']) ? $convenio_webservice['dadosProponente']['endereco'] . ' - ' . $convenio_webservice['dadosProponente']['bairroDistrito'].'. '. $convenio_webservice['dadosProponente']['municWS']['nome'] . ' - '. $convenio_webservice['dadosProponente']['municWS']['unidadeFederativaWS']['sigla'].'. CEP: '.$convenio_webservice['dadosProponente']['cep'] : '',
                'BAIRRO_PROPONENTE' => isset($convenio_webservice['dadosProponente']['bairroDistrito']) ? $convenio_webservice['dadosProponente']['bairroDistrito'] : '',
                'CEP_PROPONENTE' => isset($convenio_webservice['dadosProponente']['cep']) ? $convenio_webservice['dadosProponente']['cep'] : '',
                'EMAIL_PROPONENTE' => isset($convenio_webservice['dadosProponente']['email']) ? $convenio_webservice['dadosProponente']['email'] : '',
                'TELEFONE_PROPONENTE' => isset($convenio_webservice['dadosProponente']['telefone']) ? $convenio_webservice['dadosProponente']['telefone'] : '',
            ...
            if (isset($convenio_webservice['propostaWS']['empenhoWS'])) {
                $data['EMPENHO_ano'] = isset($convenio_webservice['propostaWS']['empenhoWS']['ano']) ? $convenio_webservice['propostaWS']['empenhoWS']['ano'] : '';
                $data['EMPENHO_codigoFonteRecurso'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoFonteRecurso']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoFonteRecurso'] : '';
                $data['EMPENHO_codigoNaturezaDespesa'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoNaturezaDespesa']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoNaturezaDespesa'] : '';
                $data['EMPENHO_codigoPlanoInterno'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoPlanoInterno']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['codigoPlanoInterno'] : '';
                $data['EMPENHO_codigoAutorEmenda'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['codigoAutorEmenda']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['codigoAutorEmenda'] : '';
                $data['EMPENHO_programaTrabalho'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['programaTrabalho']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['programaTrabalho'] : '';
                $data['EMPENHO_programaTrabalhoResumido'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['programaTrabalhoResumido']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['programaTrabalhoResumido'] : '';
                $data['EMPENHO_resultadoPrimario'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['resultadoPrimario']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['resultadoPrimario'] : '';
                $data['EMPENHO_unidadeOrcamentaria'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['unidadeOrcamentaria']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['programaTrabalhoResumidoWS']['unidadeOrcamentaria'] : '';
                $data['EMPENHO_ugResponsavel'] = isset($convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['ugResponsavel']) ? $convenio_webservice['propostaWS']['empenhoWS']['celulaOrcamentariaWS']['ugResponsavel'] : '';
                $data['EMPENHO_numeroEmpenho'] = isset($convenio_webservice['propostaWS']['empenhoWS']['numeroEmpenho']) ? $convenio_webservice['propostaWS']['empenhoWS']['numeroEmpenho'] : '';
                $data['EMPENHO_situacaoEmpenho'] = isset($convenio_webservice['propostaWS']['empenhoWS']['situacaoEmpenho']) ? $convenio_webservice['propostaWS']['empenhoWS']['situacaoEmpenho'] : '';
                $data['EMPENHO_ugEmitenteEmpenho'] = isset($convenio_webservice['propostaWS']['empenhoWS']['ugEmitente']) ? $convenio_webservice['propostaWS']['empenhoWS']['ugEmitente'] : '';
                $data['EMPENHO_valorOriginal'] = isset($convenio_webservice['propostaWS']['empenhoWS']['valorOriginal']) ? $convenio_webservice['propostaWS']['empenhoWS']['valorOriginal'] : '';
            }
